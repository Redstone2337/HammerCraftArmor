...
import net.redstone233.morearmor.items.armor.ModArmorItem;
...
public class ModArmorItems {
    ...
    public static final Item HAMMER_CRAFT_HELMET = register("hammer_helmet",
            (settings) -> new ModArmorItem(ModArmorMaterials.DEFAULT, EquipmentType.HELMET,
    ...
    public static final Item HAMMER_CRAFT_CHESTPLATE = register("hammer_chestplate",
            (settings) -> new ModArmorItem(ModArmorMaterials.DEFAULT, EquipmentType.CHESTPLATE,
    ...
    public static final Item HAMMER_CRAFT_LEGGINGS = register("hammer_leggings",
            (settings) -> new ModArmorItem(ModArmorMaterials.DEFAULT,EquipmentType.LEGGINGS,
    ...
    public static final Item HAMMER_CRAFT_BOOTS = register("hammer_boots",
            (settings) -> new ModArmorItem(ModArmorMaterials.DEFAULT,EquipmentType.BOOTS,
