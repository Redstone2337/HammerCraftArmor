...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, List<StatusEffectInstance>> MAP =
            (new ImmutableMap.Builder<ArmorMaterial,List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.DEFAULT,
                            Arrays.asList(
                                    new StatusEffectInstance(StatusEffects.GLOWING,1000,1,false,false,true),
                                    new StatusEffectInstance(StatusEffects.SLOW_FALLING,1000,2,false,false,true),
                                    new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE,1000,3,false,false,true)
                            )).build();
