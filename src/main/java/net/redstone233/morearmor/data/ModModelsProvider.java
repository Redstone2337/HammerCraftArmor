...
//        itemModelGenerator.registerArmor(ModArmorItems.HAMMER_CRAFT_BOOTS, EquipmentModels.NETHERITE, EquipmentModel.builder().addLayers(EquipmentModel.LayerType.HUMANOID).build(), EquipmentSlot.FEET);
        itemModelGenerator.registerArmor(ModArmorItems.HAMMER_CRAFT_HELMET, Identifier.of("hammer_helmet"), EquipmentModel.builder().addMainHumanoidLayer(Identifier.of(HammerCraftArmor.MOD_ID,"default"),true).build(),EquipmentSlot.HEAD);
        itemModelGenerator.registerArmor(ModArmorItems.HAMMER_CRAFT_CHESTPLATE, Identifier.of("hammer_chestplate"), EquipmentModel.builder().addMainHumanoidLayer(Identifier.of(HammerCraftArmor.MOD_ID,"default"),true).build(),EquipmentSlot.CHEST);
        itemModelGenerator.registerArmor(ModArmorItems.HAMMER_CRAFT_LEGGINGS, Identifier.of("hammer_leggings"), EquipmentModel.builder().addMainHumanoidLayer(Identifier.of(HammerCraftArmor.MOD_ID,"default"),true).build(),EquipmentSlot.LEGS);
        itemModelGenerator.registerArmor(ModArmorItems.HAMMER_CRAFT_BOOTS, Identifier.of("hammer_boots"), EquipmentModel.builder().addMainHumanoidLayer(Identifier.of(HammerCraftArmor.MOD_ID,"default"),true).build(),EquipmentSlot.FEET);
    }
}
